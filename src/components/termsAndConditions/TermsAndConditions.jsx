  ...
  return (
    ...
    <div className='snap-start container_terms_and_conditions'>
        ...
        <div className='terms_and_cond_heading'>
            <img src="./white/termsandcond.svg" alt="" />
        </div>
        ...
        <div className='span-b'>
            ...
            <div className="paragraphOne">
                <header className='para_header'>1. Terms of service</header>
                <hr />
            ...
            <div className="paragraphTwo">
                <header className='para_header'>1.1 Overview Ipsum</header>
                <hr />
                <p style={{width: "50%"}}>
            ...
            <div className="paragraphThree">
                <header className='para_header'>1.2 Lorem Ipsum</header>
                <hr />
            </div>
        </div>
    </div>
